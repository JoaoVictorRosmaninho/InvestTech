...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference("Fund.count") do
      post funds_url, params: { fund: { creation_date: @fund.creation_date, desc_fund: @fund.desc_fund, name_fund: @fund.name_fund } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { creation_date: @fund.creation_date, desc_fund: @fund.desc_fund, name_fund: @fund.name_fund } }
