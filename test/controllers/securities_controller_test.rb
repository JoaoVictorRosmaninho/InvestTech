...
class SecuritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create security" do
    assert_difference("Security.count") do
      post securities_url, params: { security: { creation_date: @security.creation_date, security_simbol: @security.security_simbol } }
    end
  ...
  test "should update security" do
    patch security_url(@security), params: { security: { creation_date: @security.creation_date, security_simbol: @security.security_simbol } }
